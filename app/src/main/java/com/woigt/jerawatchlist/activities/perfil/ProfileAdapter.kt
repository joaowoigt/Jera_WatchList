...
/**
 *  Adapter for the Profile list on the Main Activity
 */
class ProfileAdapter(options: FirestoreRecyclerOptions<Profile>,
                     val profileLogin: (Profile) -> Unit) :
    FirestoreRecyclerAdapter<Profile, ProfileAdapter.PerfilHolder>(options) {
